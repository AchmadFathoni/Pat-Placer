...
(function() {
  ...
  Promise.all([
    injectScript(BASE + '/scripts/image-processor.js', 'patplacer-image-processor-script'),
    injectScript(BASE + '/scripts/patplacer-main.js', 'patplacer-main-script'),
    injectScript(BASE + '/scripts/art-extractor.js', 'patplacer-extractor-script'),
    injectScript(BASE + '/scripts/repair-tool.js', 'patplacer-repair-script')
  ]).then(() => {
